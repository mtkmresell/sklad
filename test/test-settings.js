...
(async () => {
  ...
  check('všech 11 nástrojů vykresleno', d.data.count === 11, String(d.data.count));
  ...
  check('popisky zůstaly beze změny',
    JSON.stringify(d.data.labelsIntact) === JSON.stringify(['Správa platforem', 'Tabulky velikostí', 'Import', 'Export', 'Dropdowny', 'Retaileři & EU limit', 'Kurzy měn', 'Komisní prodej', 'Databáze našeptávače', 'Posty na Instagramu', 'Údaje pro doklad']),

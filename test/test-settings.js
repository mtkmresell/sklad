...
(async () => {
  ...
  check('všech 8 nástrojů vykresleno', d.data.count === 8, String(d.data.count));
  ...
  check('popisky zůstaly beze změny',
    JSON.stringify(d.data.labelsIntact) === JSON.stringify(['Správa platforem', 'Tabulky velikostí', 'Import', 'Export', 'Dropdowny', 'Retaileři & EU limit', 'Přepočítat kurzy ČNB', 'Databáze našeptávače']),
